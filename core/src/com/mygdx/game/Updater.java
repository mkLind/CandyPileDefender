...
public class Updater implements Screen {
	...
	public Updater(final Core game) {
		...
		ambience = game.getLoader().getManager().get(
				"C:/CandyPile/CandyPileDefender/core/assets/Music/POL-horror-ambience-1-short_16bit.wav", Music.class);
		ambience.setLooping(true);
		ambience.play();

		shot = game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/shooting/NFF-gun-miss.wav", Sound.class);
		hit = game.getLoader().getManager().get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/hit/NFF-slap-02.wav",
				Sound.class);
		Explosion = game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/hit/NFF-explode.wav", Sound.class);
		GameOver = game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/game_over/NFF-death-bell.wav", Sound.class);
		walk1 = game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/walking/grass1.wav", Sound.class);
		walk2 = game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/Sounds/walking/gravel1.wav", Sound.class);
		...
		for (int i = 0; i < spawnPoints.size; i++) {
			...
			if (spawnPoints.get(i).getProperties().get("Spawnpoint").toString().equals("Pile")) {
				pile = new Pile(87, 62, spawnPoints.get(i).getRectangle().getX(),
						...
						game.getLoader().getManager().get("C:/CandyPile/CandyPileDefender/core/assets/CPBigCrop.png",
								Texture.class),
						game.getLoader().getManager().get("C:/CandyPile/CandyPileDefender/core/assets/CPMedCrop.png",
								Texture.class),
						game.getLoader().getManager().get("C:/CandyPile/CandyPileDefender/core/assets/CPSmallCrop.png",
								Texture.class),
						game.getLoader().getManager().get("C:/CandyPile/CandyPileDefender/core/assets/CPTinyCrop.png",
								Texture.class));
			}
		}
		for (int i = 0; i < spawnPoints.size; i++) {
		...
		player.setAnimations(8, 3, 0.10f, game.getLoader().getManager()
				.get("C:/CandyPile/CandyPileDefender/core/assets/PirateTileset.png", Texture.class));
		...
		if (Intersector.overlaps(player.getHitbox(), pile.getHitbox()) || noEnemies == false) {
			...
			if (player.getPowerupType() == POWERUPTYPE.SLOWDOWN
				...
				MapObject obj = new MapObject(
						32, 32, player.getX(), player.getY(), 0, 0, 10000, game.getLoader().getManager()
								.get("C:/CandyPile/CandyPileDefender/core/assets/tarstain.png", Texture.class),
						OBJECTTYPE.HAZARD);
			...
			if (Intersector.overlaps(powerups.get(i).getHitbox(), player.getHitbox())) {
				...
				if (player.getPowerupType() == POWERUPTYPE.SHIELD) {
					MapObject obj = new MapObject(40, 40, player.getX() - player.getWidth() / 2,
							player.getY() + player.getHeight() / 2, 0, 0, 10000, game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/SHIELD.png", Texture.class),
							OBJECTTYPE.FOLLOWER);
					obj.setSpawnTime(TimeUtils.millis());
					mapObjects.add(obj);
				}
				...
				if (player.getPowerupType() == POWERUPTYPE.CLEARSCREEN) {
					MapObject obj = new MapObject(32, 32, player.getX() - player.getWidth() / 2,
							...
							game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/ScreenClear.png", Texture.class),
							OBJECTTYPE.EXPANDER);
					obj.setSpawnTime(TimeUtils.millis());
					mapObjects.add(obj);
					Explosion.play();
		...
		if (Gdx.input.isTouched() && TimeUtils.timeSinceMillis(player.getLastShot()) > player.getShootingCooldown()) {
			...
			if (player.getPowerupType() != POWERUPTYPE.TRIPLESHOT) {
				...
				if (tmp == 0) {
					...
					Projectile p = new Projectile(15, 15, player.getX() + player.getWidth() / 2,
							player.getY() + player.getHeight() / 2, velX, velY, game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/Carrot.png", Texture.class));
				...
				if (tmp == 1) {
					...
					Projectile p = new Projectile(15, 15, player.getX() + player.getWidth() / 2,
							player.getY() + player.getHeight() / 2, velX, velY, game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/Tomato.png", Texture.class));
					p.setTargetX(reaCoords.x);
					p.setTargetY(reaCoords.y);
					p.setCurrentTime(TimeUtils.millis());
					proj.add(p);
				...
				if (tmp == 2) {
					...
					Projectile p = new Projectile(15, 15, player.getX() + player.getWidth() / 2,
							player.getY() + player.getHeight() / 2, velX, velY, game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/Broccoli.png", Texture.class));
					p.setTargetX(reaCoords.x);
					p.setTargetY(reaCoords.y);
					p.setCurrentTime(TimeUtils.millis());
					proj.add(p);
				...
				if (tmp == 3) {
					...
					Projectile p = new Projectile(15, 15, player.getX() + player.getWidth() / 2,
							player.getY() + player.getHeight() / 2, velX, velY, game.getLoader().getManager()
									.get("C:/CandyPile/CandyPileDefender/core/assets/EggPlant.png", Texture.class));
					p.setTargetX(reaCoords.x);
					p.setTargetY(reaCoords.y);
					p.setCurrentTime(TimeUtils.millis());
					proj.add(p);
